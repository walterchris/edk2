...
cp ../blobs/mainboard/samsung/stumpy/vbt.bin CorebootPayloadPkg/vbt.bin
...
cp Build/CorebootPayloadPkgX64/RELEASE_GCC5/FV/UEFIPAYLOAD.fd ../UEFIPAYLOAD-snb-box.fd
